...
import edu.ezip.ing1.pds.business.server.EcoptimizeService;
...
public class RequestHandler implements Runnable {
    ...
    private final EcoptimizeService ecoptimizeService = EcoptimizeService.getInstance();
    ...
    public void run() {
        try {
            ...
            final Response response = ecoptimizeService.dispatch(request, connection);
    ...
    private final Request getRequest(byte [] data) throws IOException {
        ...
        logger.debug( "aa"+request.toString());
        return request;
    }
